                        ...
                        <div class="inside store_locator_map_settings">
                            ...
                            <p>
                                ...
                                <ul class="hide_fields" style="margin-left: 36%">
                                    <li><input <?php echo ($map_options['search_field_get_my_location'])?'checked':''; ?> value="hide-field" type="checkbox" id="search_field_get_my_location" name="store_locator_map[search_field_get_my_location]" > Get My Location</li>
                                    <li><input <?php echo ($map_options['search_field_location'])?'checked':''; ?> value="hide-field" type="checkbox" id="search_field_get_my_location" name="store_locator_map[search_field_location]" > Location Field</li>
                                    <li><input <?php echo ($map_options['search_field_radius'])?'checked':''; ?> value="hide-field" type="checkbox" id="search_field_get_my_location" name="store_locator_map[search_field_radius]" > Radius Field</li>
                                    <li><input <?php echo ($map_options['search_field_category'])?'checked':''; ?> value="hide-field" type="checkbox" id="search_field_get_my_location" name="store_locator_map[search_field_category]" > Category Field</li>
                                    <li><input <?php echo ($map_options['search_field_tags'])?'checked':''; ?> value="hide-field" type="checkbox" id="search_field_get_my_location" name="store_locator_map[search_field_tags]" > Tags Field</li>
                                </ul>
                            </p>

                            <p>
                                <label title="Map Search Open as Default" for="map_window_open"><?php echo __("Map Search Open as Default", 'store_locator'); ?></label>
                                <input <?php echo ($map_options['map_window_open'])?'checked':''; ?> value="1" type="checkbox" id="map_window_open" name="store_locator_map[map_window_open]" >
                            </p>
							
							<p>
                                <label title="Switch To RTL" for="rtl_enabled"><?php echo __("Switch To RTL", 'store_locator'); ?></label>
                                <input <?php echo ($map_options['rtl_enabled'])?'checked':''; ?> value="1" type="checkbox" id="rtl_enabled" name="store_locator_map[rtl_enabled]" >
                            </p>
